...
export { seTweetText, TweetProvider as TweetProvider, useTweetState as useTweetState, useTweetDispatch, likeTweet, setTweetList, setHashTagList, updateHashTagList };

// ###########################################################

function seTweetText(dispatch, tweetText) {
    dispatch({
        type: 'SET_TWEET_TEXT',
        payload: tweetText
    })
